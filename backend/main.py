...
from app.api.v1 import auth, users, roles, role_templates, permissions, widgets, students, forms, emails, password_reset, profile, email_verification, two_factor, audit_logs, database_backup, bulk_operations, search, reports
...
app.include_router(bulk_operations.router, prefix="/api/v1")
